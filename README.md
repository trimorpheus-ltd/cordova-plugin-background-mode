This is a fork of [a fork](https://bitbucket.org/TheBosZ/cordova-plugin-run-in-background) of [a great plugin by katzer](https://github.com/katzer/cordova-plugin-background-mode/). It aims to keep up-to-date with Android changes while also providing more features.

This fork has been created in order to make the Android source code compatible with Java 6.
